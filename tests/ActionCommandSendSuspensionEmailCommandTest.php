...
class ActionCommandSendSuspensionEmailCommandTest extends TestCase
{
    ...
    public function test_send_email_have_clean_exit()
    {
        ...
        $this->mockEmail(
                ...
                $company,
                'Licence Suspension',
                'emails.company-suspension'
            );

        $this->seeInDatabase('companies', ['id' => $company->id]);

        $sendEmail = new ActionCommandSendSuspensionEmailCommand($company->id);
